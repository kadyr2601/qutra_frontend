            ...
            {!createdKey ? (
              <>
                ...
                <div className="space-y-8 py-4">
                  ...
                  {/* Step 3: RAG Type */}
                  <div className="space-y-3">
                    <Label className="text-base font-semibold">3. RAG Configuration</Label>
                    <RadioGroup 
                      value={newKeyRagType} 
                  ...
                  {/* Step 4: Graph DB Toggle */}
                  <div className="space-y-3">
                    <Label className="text-base font-semibold">4. Graph Database Integration</Label>
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-3">
                      <Label className="text-base font-semibold">5. Embedding Model</Label>
